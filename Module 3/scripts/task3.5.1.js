...
function shoppingCartTotalPrice(arr){ //1. create a function that takes 1 argument (the array)
        ...
        for(var index = 0; index < arr.length; index++ ){
            ...
            totalPrice = totalPrice + (arr[index].price * arr[index].quantity ); //3. Loop through each item in the array and add the value of the item to the total price, remember to account for the quantiity
        } 
