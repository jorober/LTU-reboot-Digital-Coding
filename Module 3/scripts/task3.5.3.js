...
return totalPrice.toFixed(2);
  ...
  document.write ('test' + discountAmount( shoppingCart, 20, 'any' ) );
  document.write ('test' + discountAmount( shoppingCart, 20, 'food' ) );
  document.write ('test' + discountAmount( shoppingCart, 20, 'home' ) );
